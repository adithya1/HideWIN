...
window.addEventListener('error', function(e) {
    const fs = require('fs');
    fs.appendFileSync('C:/Users/akula/Downloads/Hide-WIN/error_log.txt', 'ERROR: ' + e.message + '\n' + e.filename + ':' + e.lineno + '\n');
});
window.addEventListener('unhandledrejection', function(e) {
    const fs = require('fs');
    fs.appendFileSync('C:/Users/akula/Downloads/Hide-WIN/error_log.txt', 'PROMISE REJECTION: ' + (e.reason && e.reason.stack ? e.reason.stack : e.reason) + '\n');
});
