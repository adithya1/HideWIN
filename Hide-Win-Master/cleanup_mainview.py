...
code = code.replace(mobile_css_new, """        @media (max-width: 768px) {
            .home-container {
                padding: 0 !important;
                background: var(--bg-app) !important;
            }
...
if mobile_html_new in code:
    code = code.replace(mobile_html_new, '')
    print("Reverted HTML in MainView.js")
else:
    print("Could not find HTML to revert.")
