...
import { render } from './CustomizeViewRenderer.js';
import { customizeStyles } from './CustomizeView.styles.js';
...
export class CustomizeView extends LitElement {
    ...
    renderProfileTab() {
        return html`
            <div class="legacy-settings-wrapper" style="max-width: 800px; padding: 24px; margin: 0 auto; overflow-y: auto; height: 100%;">
