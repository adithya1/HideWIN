...
# I will rewrite the entire @media (max-width: 750px), (max-height: 600px) block
# to fix the child-dropdown width and add a max-width: 450px block for the vertical stack.
new_media = '''
        ...
        @media (max-width: 750px), (max-height: 600px) {
            ...
            .action-dropdown-content { padding: 4px 8px !important; gap: 4px !important; border-radius: 6px; border: 1px solid var(--border); background: var(--bg-surface); }
            ...
            /* FIX FOR POPUP MENU WIDTH SQUEEZING */
            .child-dropdown { min-width: 200px !important; max-width: 300px !important; }
            
            .mouse-toggle-wrapper { transform: scale(0.75); transform-origin: center right; margin-left: auto !important; }
...
with open(fpath, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated MainView.js with Grid stack and popup width fixes.")
