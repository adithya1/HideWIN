...
# Find old function start and end
match = re.search(r'@router\.post\("/remote-control"\).*?return {"status": "error", "message": str\(e\)}', content, re.DOTALL)
if match:
    ...
    print("Could not find old function via regex")
