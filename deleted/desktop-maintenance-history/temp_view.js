    ...
    async handleMergedUpload(e) {
        ...
        for (const file of files) {
            if (file.type.startsWith('image/')) {
                ...
                // Document ΓÇö validate format and create note with progress simulation, NO auto-expand
                ...
                if (OFFICE_EXTS.includes(ext)) {
                    // Office conversion ΓÇö simulate progress while converting
