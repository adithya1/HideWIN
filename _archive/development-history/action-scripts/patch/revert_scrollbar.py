...
bad_scroll = """            /* GLOBAL POSH SCROLLBAR (Very Lean, rounded, subtle arrows) */
            ::-webkit-scrollbar {
...
good_scroll = """            /* GLOBAL POSH SCROLLBAR (Same as picture) */
            ::-webkit-scrollbar {
...
code = code.replace(bad_scroll, good_scroll)
...
code2 = code2.replace(bad_scroll2, good_scroll2)

with open('src/components/app/HideWinApp.js', 'w', encoding='utf-8') as f:
    f.write(code2)

print("Reverted scrollbars in index.html and HideWinApp.js")
