...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await hideWin.getVersion();
            const response = await fetch('https://raw.githubusercontent.com/sohzm/hide-win/refs/heads/master/package.json');
    ...
    async _openUpdatePage() {
        ...
        await ipcRenderer.invoke('open-external', 'https://hidewin.com');
    }
    ...
    getViewTitle() {
        ...
        return titles[this.currentView] || 'HideWin';
    }
                ...
                <div class="header-actions">
                    ...
                    ${this.currentView === 'main'
                        ? html`
                              ...
                              ` : ''}
                              <button class="icon-button" @click=${() => window.hideWin.theme.load().then(t => window.hideWin.theme.save(t === 'light' ? 'dark' : 'light'))}>
                                  🌓
                              </button>
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${hideWin.isMacOS ? 'Cmd' : 'Ctrl'}</span
